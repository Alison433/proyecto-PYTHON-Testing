...
class ServiceTypeModelTestCase(TestCase):
    def test_service_type_creation(self):
        ...
        service_type = Service_Type.objects.create(
            ...
            service_type_description="Verify Service creation"
        )

     
        self.assertEqual(service_type.service_type_name, "Service Type")
        self.assertEqual(service_type.service_type_description, "Verify Service creation")
